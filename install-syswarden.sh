...
EOF
        ...
        if [[ "${USE_WIREGUARD:-n}" == "y" ]]; then
            ...
            # --- STRICT ZERO TRUST HIERARCHY (v2.20) - DEBIAN PARITY) ---
...
uninstall_syswarden() {
    ...
    # --- Clean up all SysWarden Fail2ban filters (Including v2.20 additions) ---
...
# ==============================================================================
# SYSWARDEN v2.20 - TELEMETRY BACKEND
# ==============================================================================
                ...
                for IP in $BANNED_IPS; do
                    if [[ -n "$IP" ]]; then
                        ...
                        if [[ "$JAIL" =~ (recidive) ]]; then
                            ...
                            # Extract protocol and destination port for ultimate forensic clarity
